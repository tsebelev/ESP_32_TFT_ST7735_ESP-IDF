        ...
        with open(output_path, 'w') as f:
            ...
            for y in range(160):
                for x in range(128):
                    ...
                    # Вариант 1: Стандартный RGB565 (RRRRRGGGGGGBBBBB)
                    # rgb565 = ((r >> 3) << 11) | ((g >> 2) << 5) | (b >> 3)
                    
                    # Вариант 2: BGR565 (поменяны R и B) - для некоторых дисплеев
                    rgb565 = ((b >> 3) << 11) | ((g >> 2) << 5) | (r >> 3)
                    
                    # Вариант 3: RBG565 (поменяны G и B) - если зелёный и синий перепутаны
                    # rgb565 = ((r >> 3) << 11) | ((b >> 2) << 5) | (g >> 3)
